...
//  возвращает true - если сейчас нажата/удерживается хоть какая-то Кнопка
//
// Исключение: при сканировании статусов, игнорируем Кнопки в состояниии "отложенный сброс"!
// (что означает, кнопка была нажата, и возможно еще удерживается... 
//  но событие уже отработано в прикладном коде! 
//  поэтому решено считать такие кнопки "не нажатыми")
//---------------------------------------------------------------------------
